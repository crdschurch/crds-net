...
group :jekyll_plugins do
  ...
  gem "jekyll-crds", git: 'https://github.com/crdschurch/jekyll-crds.git', branch: 'feature/US15878-shared-templates'
  # gem "jekyll-crds", path: File.join(File.dirname(__FILE__), '../jekyll-crds')
