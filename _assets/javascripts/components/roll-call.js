(function() {
  var crdsRollCall = function(idx, el) {
    var els = {
      container: $(el),
      decreaseTotal: $(el).find('[data-role="decreaseTotal"]').first(),
      increaseTotal: $(el).find('[data-role="increaseTotal"]').first(),
      form: $(el).find('[data-role="form"]').first(),
      total: $(el).find('[data-role="total"]').first(),
      submit: $(el).find('[data-role="submit"]').first(),
      labelNoun: $(el).find('[data-role="labelNoun"]').first(),
      labelVerb: $(el).find('[data-role="labelVerb"]').first(),
      helpText: $(el).find('[data-role="helpText"]').first(),
      errorText: $(el).find('[data-role="errorText"]').first(),
      successText: $(el).find('[data-role="successText"]').first()
    }
