...
contentful_id: 7vWfu8lYp637BuymOY2sy5
...
description: "TRANSFORMING BETRAYAL\nDURATION: 18 WEEKS \n\nWe'll explore how to manage
  life in the earlier parts of discovery, seeking to understand what sexual addiction
  is, and supporting each other as we process. Each week we'll explore a new healing
  topic. Some of the topics include:\n\n- Safe people\n- Coping\n- Non-negotiable
  boundaries\n- Choices\n- Anger\n- Oakley\n- Thursdays, 7:00-8:30pm\n- Childcare
  is available with one week advance registration.\n\n\n*Attendance for every week
  is highly encouraged as the safety and consistency of the group is very important.
  There is required homework and journaling.\n\nIf you would like to participate in
  an upcoming group, sign up here. You can also check out an Introduction Meeting
