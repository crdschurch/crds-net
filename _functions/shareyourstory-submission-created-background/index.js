...
exports.handler = async (event, _ctx, cb) => {
  try {
    ...
    console.log('TEST function ran, fields:', payload.data);
    return cb(null, { statusCode: 200, body: 'ok' });
  } catch (e) {
    console.error('TEST func error', e);
    return cb(null, { statusCode: 500, body: e.message });
  }
};
